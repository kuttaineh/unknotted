...
### Means of Production
There exists a materialist reductivist construct which history proves is useful for the purpose of dividing the groups held subject to it. Side-stepping from that allows one to see the means of production, as defined by the Classical Liberals, as **natural resources**, **labor**, and **durable capital goods**.
