...
### Means of Production
There exists a materialist reductivist construct, which experience proves useful for the purpose of dividing the groups held subject to it. Side-stepping from that allows one to see the means of production as defined by the Classical Liberals ~~who recognized the three components of production~~ as **natural resources**, **labor**, and **durable capital goods**.
