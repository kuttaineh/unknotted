...
Plays for control and posession result in poverty, injury, and death. Instead, we can focus on the quality of everyone's life equally by looking into securing the components necessary so that all are able to live their whole lives in a thriving way. The present situation and its disentaglement:
...
There exists a materialist reductivist construct which history proves is useful for the purpose of dividing the groups held subject to it. Disregarding the construct allows one to see the means of production, recognized by the Classical Liberals, as **natural resources**, **labor**, and **durable capital goods**.
...
Chartered counties can become the one source responsible for tax collection while the state and federal revenue services can be eliminated. Revenues collected locally can then be split into the county, state, and federal balance sheets. The government institutions County, State, and Federal have to be held to serve the people equally. And these shall have to live within their means—just as people themselves.
