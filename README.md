...
Plays for control and posession result in poverty, injury, and death. We can focus on the quality of everyone's life equally by looking into the components necessary to live wholly and securely in order to insure the case. The present situation and its disentaglement:
...
### Means of Production
There exists a materialist reductivist construct which history proves is useful for the purpose of dividing the groups held subject to it. Disregarding the construct allows one to see the means of production, as defined by the Classical Liberals, as **natural resources**, **labor**, and **durable capital goods**.
